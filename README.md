# HolyEvalExpr
HolyEvalExpr is a simple mathematical expression evaluator done in HolyC using HCC and an LL(1) parsing grammar, it stands more as a joke than a practical project.
